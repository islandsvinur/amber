...
\begin{figure}[htp]
  \centering
  \includegraphics{\designpath/image/class-diagram-module}
  \caption{
...
\begin{figure}[htp]
  \centering
  \includegraphics{\designpath/image/class-diagram-ambermessage}
  \caption{
...
\begin{figure}[htp]
  \centering
  \includegraphics{\designpath/image/class-diagram}
  \caption{
...
\input{\designpath/05/classes/javadoc.inc}
...
\input{\designpath/05/sequences/01-crawler-lifecycle.inc}

\input{\designpath/05/sequences/02-sieve-lifecycle.inc}

\input{\designpath/05/sequences/03-showoff-lifecycle.inc}

\input{\designpath/05/sequences/04-story-lifecycle.inc}

\input{\designpath/05/sequences/05-analysis-lifecycle.inc}

\input{\designpath/05/sequences/06-particle-lifecycle.inc}
